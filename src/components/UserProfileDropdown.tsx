...
  // MENGAMBIL SEMUA DATA DARI CONTEXT
  const { 
    userProfile, 
    isLoggedIn, 
    isWriter, 
...
  // Periksa jika userProfile null (tidak mungkin terjadi jika dropdown dirender)
...
  
  // Inisialisasi state editForm dengan userProfile dari context
  const [editForm, setEditForm] = useState(userProfile); 
  
  const navigate = useNavigate();

  // PERHATIAN: Pastikan Anda memanggil contextLogout, bukan onLogout dari props
  const handleLogout = () => {
    onLogout(); // Panggil fungsi logout yang diwariskan (jika ada logika tambahan di parent)
    contextLogout(); // Panggil fungsi logout utama dari Context
  };
...
    // Logika pengalihan yang BENAR dan terpusat
    if (isAdmin) {
      navigate('/admin');
    } else if (isWriter) {
      navigate('/writer');
...
          {/* Dashboard/Admin Link (Prioritas Admin/Penulis) */}
          {(isAdmin || isWriter) && (
